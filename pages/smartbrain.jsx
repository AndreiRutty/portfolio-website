    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <Link href="https://andreirutty.github.io/smart-brain/"><a target="_blank" rel="noopener noreferrer"><button className="px-8 py-2 mt-4 mr-8 hover:scale-110 ease-in duration-150">Demo</button></a></Link>
          <Link href="https://github.com/AndreiRutty/smart-brain-frontend"><a  target="_blank" rel="noopener noreferrer"><button className="px-8 py-2 mt-4 hover:scale-110 ease-in duration-150">Code</button></a></Link>
        </div>
